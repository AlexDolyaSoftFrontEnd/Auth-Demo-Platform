Вот обновленный **README.md** без иконок, скриптов, лицензии и благодарностей:

```markdown
# LoginForm - Форма авторизации Welthungerhilfe

Современная форма входа на React с использованием TypeScript, Redux Toolkit, Formik и Yup с валидацией по домену электронной почты.
